...
export class SelectService {
  ...
  async handleSelectRequest(body: any) {
    try {
          ...
          fulfillment: [
            {
              ...
              customer: body.message.order.fulfillments[0].customer,
            },
          ],
        }),
      };
      ...
      // const custId = body.message.order.fulfillments[0].customer?.person?.id;
      ...
      //               },
      //             },
      //             data: `query MyQuery {\n  query_resolver_table(where: {vch_aadharno: {_eq: "${custId}"}}) {\n    int_day\n    int_gender\n    int_marital_status\n    int_month\n    int_primary_mobile_number\n    int_year\n    vch_aadharno\n    vch_address\n    vch_farmer_name\n    vch_father_name\n    vch_village\n    vch_district\n  }\n}\n`,
      //             user: {
      //               id: custId,
      //             },
      //             proof: {
      ...
      //           total_attempts: 0,
      //         },
      //         gql: `query MyQuery {\n  query_resolver_table(where: {vch_aadharno: {_eq: "${aadhar_email_maps[
      //           body.message.order.fulfilment.customer.person.cred
      //         ]
      //           }"}}) {\n    int_day\n    int_gender\n    int_marital_status\n    int_month\n    int_primary_mobile_number\n    int_year\n    vch_aadharno\n    vch_address\n    vch_farmer_name\n    vch_father_name\n    vch_village\n    vch_district\n  }\n}\n`,
      //       },
      //       {
